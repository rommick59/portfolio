      ...
      technologyCategories: [
        {
          ...
          note: 'Interfaces, UX et apps hybrides',
          items: [
        ...
        },
        {
          id: 'back',
          title: 'Back-end & APIs',
          note: 'Services, logique métier et architectures web',
          items: [
        ...
        },
        {
          id: 'data',
          title: 'Données & Bases',
          note: 'Stockage relationnel et NoSQL',
          items: [
        ...
        },
        {
          ...
          note: 'Performance, bas niveau et algorithmique',
          items: [
        ...
        },
        {
          ...
          note: 'Conteneurs, orchestration et CI/CD',
          items: [
